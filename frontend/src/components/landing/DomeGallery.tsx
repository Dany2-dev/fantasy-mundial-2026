...
// Adaptado de React Bits (DomeGallery) a TypeScript. La lógica de animación
// manipula el DOM directamente con nombres de clase literales (no CSS
// Modules) porque hace querySelector sobre esos nombres — por eso el CSS
// se importa como hoja de estilos normal, no como módulo.
...
interface Props {
  ...
  grayscale?: boolean;
  /** Gira el dome solo cuando el usuario no lo está arrastrando ni hay una imagen abierta. */
  autoRotate?: boolean;
  /** Velocidad del giro automático, en grados por segundo. */
...
function buildItems(pool: (string | GalleryImage)[], seg: number): DomeItem[] {
...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const tick = (now: number) => {
      ...
      last = now;
      // Se pausa mientras el usuario arrastra, la inercia sigue corriendo,
      // o hay una imagen abierta — para no pelear contra la interacción.
