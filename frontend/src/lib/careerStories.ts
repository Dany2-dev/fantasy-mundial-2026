    ...
    options: () => [
      {
        ...
        outcome: {
          ...
          luck: {
            ...
            onSuccess: { reputation: 6, form: 0.5, minutes: 1.1 },
    ...
    options: (c) => [
      {
        ...
        outcome: {
          ...
          luck: {
            ...
            onSuccess: { potential: 3, form: 0.4, reputation: 4 },
    ...
    options: () => [
      {
        ...
        outcome: {
          luck: {
            ...
            onSuccess: { minutes: 1.12, form: 0.35, reputation: 3 },
    ...
    options: () => [
      {
        ...
        outcome: {
          luck: {
            ...
            onSuccess: { form: 0.5, reputation: 5, minutes: 1.05 },
